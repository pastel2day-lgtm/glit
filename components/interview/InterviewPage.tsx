...
const featured = {
  ...
  intro:
    '문지희 작가를 만난 건 그녀의 첫 소설이 출간되고 두 달이 지났을 무렵이었다. 조용한 카페에서 아메리카노 한 잔을 앞에 두고, 그녀는 매일 아침 6시에 일어나 글을 쓴다고 담담하게 말했다. 특별한 영감이 올 때까지 기다리지 않는다고. 그냥 앉는 것이 전부라고.',
  qa: [
    {
  ...
  image: '/images/interview-korean-featured.png',
  date: '2026년 1월',
}
...
const interviews = [
  ...
  },
  {
    ...
    image: '/images/interview-korean-publisher.png',
    date: '2026년 4월',
    readTime: '7분',
  },
]
